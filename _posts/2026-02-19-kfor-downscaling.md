---
layout: post
title: "Washington wants KFOR wound down"
date: 2026-02-19
...
The push - described internally as a [<mark>"return to factory settings"</mark>](https://www.politico.eu/article/us-presses-nato-reset-cut-foreign-missions-allies-peacekeeping-iraq-kosovo/) - amounts to an effort to refocus the alliance on its core mandate of territorial deterrence and to shed the crisis-management operations, global partnerships, and out-of-area missions that have accumulated since the 1990s. The Kosovo Force (KFOR), a UN-mandated mission that has maintained a continuous military presence since 1999, is now on the list.
